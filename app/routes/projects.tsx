            ...
            <ul className="flex flex-col gap-4">
              {response.map((res) => (
                <Link to={res.html_url} key={res.id} className="">
                  <li className="border-2 rounded-2xl p-6 dark:border-gray-600 dark:hover:bg-neutral-900 dark:hover:border-emerald-500 hover:border-emerald-500 hover:bg-gray-100 transition-all duration-200">
